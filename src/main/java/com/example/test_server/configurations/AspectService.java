...
public class AspectService {
    @Around("execution(* com.example.test_server.services.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.example.test_server.services.*.*(..))", returning = "returnObj")
    ...
    @AfterThrowing(pointcut = "execution(* com.example.test_server.services.*.*(..))", throwing = "throwable")
